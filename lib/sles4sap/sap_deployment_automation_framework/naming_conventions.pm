...
=item * B<sut>: SDAF SUT type, 'sid' | 'iscsi'
...
sub get_sut_sshkey_path {
    ...
    # file name is hard coded in SDAF
    record_info("Returns full SUT private sshkey filepath located on deployer VM after deployment: $args{config_root_path}/$args{sut}_sshkey");
    return "$args{config_root_path}/$args{sut}_sshkey";
}
