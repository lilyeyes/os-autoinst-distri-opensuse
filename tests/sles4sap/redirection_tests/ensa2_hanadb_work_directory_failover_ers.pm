...
sub run {
    ...
    # Disable work directory /usr/sap/<sid>/<instance>/ using lazy unmount method
    record_info('Failover', "Executing 'umount -l '. Failover from $instance_hostname_ers to $instance_hostname_scs");
    assert_script_run("umount -l /usr/sap/${sap_sid}/ERS${instance_id_ers}");
